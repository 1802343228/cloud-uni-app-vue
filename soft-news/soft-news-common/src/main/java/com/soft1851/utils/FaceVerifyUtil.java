...
//                gateway = HttpClientBuilder.create().setDefaultRequestConfig(config).setSSLContext(sslContext).setSSLHostnameVerifier((x, y) -> true).build();
            ...
            String signature = HMACSha1(stringToSign, "TGb8iDSktxsVWWIQLnrCkHgTqAOgog");
            // 3.得到 authorization header
            String authHeader = "Dataplus " + "LTAI4G12S8zv5nLJr7t5K8ws" + ":" + signature;
            // 打开和URL之间的连接
